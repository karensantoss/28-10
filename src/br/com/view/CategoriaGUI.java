...
public class CategoriaGUI extends javax.swing.JFrame {
    ...
    public CategoriaGUI(DefaultTableModel modelo) {
        this.modelo = modelo;
        initComponents();
    }

    
    public CategoriaGUI(DefaultTableModel modelo, int linhaSelecionada, int IdCategoria){
        this.modelo = modelo;
        this.linhaSeIecionada = linhaSelecionada;
        initComponents();
        
        CategoriaController cc = new CategoriaController();
        Categoria c = cc.pesquisarCodigo(IdCategoria);
